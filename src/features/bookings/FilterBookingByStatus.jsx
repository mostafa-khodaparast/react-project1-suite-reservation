...
const FilterBookingByStatus = () => {
    ...
    return (
        <div dir="rtl" className="flex items-center space-x-2 ml-14 dark:text-stone-300">
            <span className="font-semibold font-beyekan ml-2 mr-14">فیلتر براساس وضعیت : </span>
            <select onChange={handleSelect} className="bg-blue-500 text-blue-950 hover:cursor-pointer font-semibold focus:outline-none py-2 text-stone-100 px-3 ml-2 border-none  rounded-sm transition-all duration-300">
