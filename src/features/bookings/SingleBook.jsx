...
const SingleBook = ({ book }) => {
    ...
    return (
        <div dir="rtl" onClick={() => navigate(`/bookings/${book.id}`)} className=" bg-slate-200 w-[90%] mx-auto my-1 font-bezar font-medium text-blue-950 rounded-sm hover:bg-slate-300 hover:cursor-pointer">
